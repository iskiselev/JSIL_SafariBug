...
JSIL.ImplementExternals("System.Runtime.CompilerServices.AsyncVoidMethodBuilder", function ($) {
    ...
    $.Method({ Static: false, Public: true }, "AwaitOnCompleted",
      ...
      function AwaitOnCompleted(TAwaiter, TStateMachine, awaiter, stateMachine) {
          awaiter = JSIL.BoxedVariable.$Is(awaiter) ? awaiter.get() : awaiter;
          stateMachine = JSIL.BoxedVariable.$Is(stateMachine) ? stateMachine.get() : stateMachine;

          var completedSignature = $jsilcore.System.Runtime.CompilerServices.INotifyCompletion.OnCompleted;
          completedSignature.Call(awaiter, null, $jsilcore.System.Action.New(stateMachine, stateMachine.MoveNext));
      }
    );
...
JSIL.ImplementExternals("System.Runtime.CompilerServices.TaskAwaiter", function ($) {
    ...
    $.Method({ Static: false, Public: true }, "GetResult",
      ...
      function GetResult() {
          ...
          //TODO: Remove hack. GetAwaiter is called by dynamic dispatcher, so it select incorrect override.
          if (this._task.get_Result) {
